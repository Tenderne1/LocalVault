...
## V1.6.3 更新签名与 GitHub Release

V1.6.3 使用 Tauri Updater，并要求更新包经过签名验证。正式发布前必须配置 updater 公钥和 GitHub Actions 私钥 Secrets。

请参阅：`docs/UPDATER_SETUP.md`

程序默认不会自动检查更新。只有用户主动点击“软件更新”才会访问 GitHub Releases。
